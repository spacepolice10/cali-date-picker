...
import * as RangerCalendarStorybooks from "./RangerCalendar.stories";
// import * as RangerCalendarStorybooks from "./Calendar.stories";

# RangerCalendar

Unopinionated utility that simplifies process of building `ranger calendar` components.

<Canvas of={RangerCalendarStorybooks.Base} />
